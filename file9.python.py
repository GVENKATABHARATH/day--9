...
# !Hybrid inheritance
# ? The combination of above 4 inheritance is called Hybrid iheritance
class c1:
    def m1(self):
        print("Class1")
...
#1.) Method overoading --> it is not possible in python
#2.) Method over riding

#1.) Tasks

d1 = {"shirt":1000, "pant":1500, "shoess":"900", "handkey":30}
#1.) Find the min ans max priced product
#2.) Find the product starts with 's' and 'S'

#2.) Find the n  = 67, is strong nujmber or not
